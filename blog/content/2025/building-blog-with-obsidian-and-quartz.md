...
지식 관리 도구로 [Obsidian](https://obsidian.md/) 을 사용하고 있는데 고민 끝에 일반적인 내용은 [Obsidian vault](https://github.com/khy07181/vault) 에 기록하고, 공유하고 싶은 내용을 블로그로 포스팅하도록 결정했다.
...
사내 위키 용도로 데모 정도까지 만들어보기도 했고, 개인적으로 팬(?)인 [haril](https://haril.dev/) 님이 만든 obsidian 플러그인 [o2](https://github.com/songkg7/o2)가 있기 때문에 사용하고 싶어서 가장 먼저 고려했다.
...
유료 요금제를 사용할 경우 뉴스레터나 멤버십 기능도 있기 때문에 좀 더 전문적으로 양질의 콘텐츠를 생산할 수 있는 능력이 되면 써도 좋을 것 같다.
