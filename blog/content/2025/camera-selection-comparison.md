...
- 니콘 Z마운트 렌즈와 저렴한 TT아티산 같은 서드파티 렌즈 사용 가능
...
- 3,300만 화소(33MP) 풀프레임 BSI-CMOS 센서 탑재
...
- 8.3K 60프레임 로우, 4K 120프레임, 레드(RED) LOG 지원
...
- 전용 배터리가 비싸고, 액세서리를 쓰면 배터리 소모 높음
...
- 전통의 영상 특화 GH 시리즈 최신작으로, 영상 분야에서 독보적이다.
