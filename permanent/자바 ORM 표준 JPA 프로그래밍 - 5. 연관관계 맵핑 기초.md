...
![JPA_RelationalMapping_1](../attachment/img/JPA_RelationalMapping_1.jpg)
...
![JPA_RelationalMapping_2](../attachment/img/JPA_RelationalMapping_2.jpg)
...
![JPA_RelationalMapping_3](../attachment/img/JPA_RelationalMapping_3.jpg)
- 테이블 연관관계
	* Member <-> Team의 연관관계 1개(양방향)
	* 테이블은 외래키 하나로 두 테이블의 연관관계를 관리한다.
	* MEMBER>TEAM_ID 외래키 하나로 양쪽으로 JOIN할 수 있다.
![JPA_RelationalMapping_4](../attachment/img/JPA_RelationalMapping_4.jpg)

### 딜레마 - 둘 중 하나로 외래 키를 관리해야 한다.

![JPA_RelationalMapping_5](../attachment/img/JPA_RelationalMapping_5.jpg)
